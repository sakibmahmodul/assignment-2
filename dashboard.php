...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <aside class="lg:w-64 bg-white shadow-lg z-10 lg:h-screen lg:sticky lg:top-0">
            ...
            <div class="p-4">
                <nav class="space-y-1">
                    <a href="dashboard.php" class="flex items-center space-x-3 p-3 rounded-lg sidebar-link active">
                    ...
                    <a href="change-password.php" class="flex items-center space-x-3 p-3 rounded-lg sidebar-link">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 text-gray-500">
                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                <div class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg">
                    <p class="text-sm"><?php echo htmlspecialchars($_SESSION['success']);
                    ...
                    <div class="p-6">
                        <div class="flex flex-col md:flex-row md:items-center">
                            ...
                            <div class="mt-4 md:mt-0 md:ml-6 flex-1">
                                ...
                                <p class="text-gray-600 mt-1">Member since
                                    <?php echo date('F Y', strtotime($user['created_at'] ?? 'now')); ?></p>
                            </div>
                        </div>
